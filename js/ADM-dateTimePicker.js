        ...
        return {
            ...
            link: function(scope, element, attrs, ctrls) {
                ...
                scope.parseInputValue = function(valueStr, resetTime, releaseTheBeast) {
                    ...
                    if (_dateTime) {
                        try {
                            ...
                            console.log('ERR:adm:1173',err.message);
                        }
                ...
                scope.openCalendar = function() {
                    ...
                    // set date if there is not a date set
                    if (scope.calType == 'jalali' && scope.dtpValue.formated == undefined ){                        
                        var day = ADMdtpFactory.convertToJalali(new Date());
                        day.hour = new Date().getHours();
                        day.minute = new Date().getMinutes();
                        var _year = day.year ; 
                        var _month = (day.month<10) ? '0'+day.month : day.month ; 
                        var _day = (day.day<10) ? '0'+day.day : day.day ; 
                        scope.dtpValue.formated = _year +'/' + _month + '/' + _day + ' - ' + day.hour + ':' + day.minute;
                    }
